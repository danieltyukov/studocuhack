...
- It runs only on `www.studocu.com`, `www.studeersnel.nl` and `www.studocu.vn`, and requests host access only to `doc-assets.studocu.com` (the CDN that serves document pages).
