document.addEventListener('load', function () {
    ...
    let checkVersion = function () {
        ...
        let up_buttons = document.querySelectorAll(".fa-cloud-arrow-up");
        up_buttons[0].parentNode.parentNode.insertBefore(button_cv, up_buttons[0].parentNode.parentElement.children[3]);
        
        updateLogo();
    }

    let updateLogo = function () {
        let logos = document.querySelectorAll('[aria-label="Studocu Logo"]');
        logos.forEach(logo => {
            logo.firstChild.innerHTML = `<g transform="matrix(0.030577, 0, 0, -0.031212, 0.081575, 28.593828)" fill="#000000" stroke="none" style=""> ... </g>`;
        });
    }
